...
$M.templateManage.viewEdit = function (S) {
    if ($M._templateManage_edit) {
            ...
            xtype: "ToolBar", items: [
                    [{ ico: "fa-save", name: "save", text: "保存", onClick: function () {
                        ...
                        ico: "fa-copy", name: "backup", text: "备份", enabled: false, onClick: function () {
                                $M.comm("templateManage.ajax.backupView", { id: S.id, html: u_html.val() }, function () { $M.alert("备份成功！"); });
        ...
        $M.comm([
                ...
                ["templateManage.ajax.readView", { id: S.id,viewName:S.viewName}]
                ], function (json) {
...
$M.templateManage.insertView = function (S) {
    ...
    $M.comm([
        ["templateManage.ajax.readView", { viewName: S.viewName }],
        ["templateManage.ajax.readViewForm", { viewName: S.viewName }]], function (json) {
