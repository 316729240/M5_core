$M.templateManage.find = function (S) {
    ...
    var find = function () {
        $M.comm("templateManage.ajax.find", { keyword: content1.val(), u_webFAid: S.u_webFAid }, function (json) {
            listGrid.clear();
    ...
    var replace = function () {
        ...
        var _rep = function () {
            ...
            $M.comm("templateManage.ajax.replace", { type: 0, mbType: listGrid.rows[index].cells[4].val(), id: listGrid.rows[index].cells[0].val(), keyword: content1.val(), keyword2: content2.val(), u_webFAid: S.u_webFAid }, function (json) {
