$M.userManage.manage = function (S) {
    ...
    var reloadClass = function () {
        $M.comm("userManage.ajax.readRole", null, function (json) {
            roleGrid.clear();
    ...
    var delGroup = function () {
        ...
        $M.confirm("您确定要删除所选角色吗（删除角色不会删除相关用户）？", function () {
            $M.comm("userManage.ajax.delRole", { id: id }, reloadClass);
        });
    };
    var addGroup = function () {
        $M.prompt("角色名称", function (value) {
            $M.comm("userManage.ajax.editRole", { id: -1, name: value }, reloadClass);
        });
    };
    var editGroup = function () {
        ...
        var id = roleGrid.selectedRows[0].cells[0].val();
        $M.prompt("角色名称", function (value) {
            $M.comm("userManage.ajax.editRole", { id: id, name: value }, function () {
