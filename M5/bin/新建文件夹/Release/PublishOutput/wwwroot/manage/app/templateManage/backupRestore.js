$M.templateManage.backupRestore = function (S) {
    ...
    $M.comm("templateManage.ajax.readBackupList", {dataId:S.dataId, u_webFAid: S.u_webFAid, classId: S.classId, u_type: S.u_type, u_defaultFlag: S.u_defaultFlag, u_datatypeId: S.u_datatypeId, title: S.title }, function (json) {
        grid.addRow(json);
    });
    win.show();
};