...
$M.dataBase.tableStructure = function (S) {
    ...
    toolBar.find("save").attr("onClick", function () {
        ...
        $M.comm("dataBase.ajax.saveDatatype", {id:S.id,tableName:S.tableName,datatypeName:S.datatypeName, data: JSON.stringify(data) }, function () {
        });
    });
    if(S.id){
        $M.comm("dataBase.ajax.readDatatype", { id: S.id }, function (data) {
