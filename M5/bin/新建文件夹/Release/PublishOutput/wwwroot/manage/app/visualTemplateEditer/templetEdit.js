...
var init = function () {
    ...
    $(document.body).on("mousedown", function (e) {
        ...
        if (className != null) {
            if (className.indexOf("m5_editData") > -1) {
                ...
                $M.comm("visualTemplateEditer.ajax.getContentData", { url: href }, function (json) {
                    ...
                    if (p!="") {
                        $M.app.call("$M.templateManage.insertView", {
                            viewName: viewValue, back: function (value) {
                                $M.comm("visualTemplateEditer.ajax.renderView", {
                                    viewName: value
                                }, function (json) {
    ...
    $("#saveTempletButton").click(function () {
        ...
        html = temp.html();
        $M.comm("visualTemplateEditer.ajax.save", { url: location.href, html: html }, function () {
            $M.alert("保存成功！");
        });
        return false;
    });
