$M.yuesaoxinxi.edit = function (S) {
    var tab = mainTab.addItem({ text: "月嫂信息", "class": "form-horizontal", closeButton: true });
    tab.focus();
    ...
    var form=tab.addControl({
        xtype: "Form",
        command: "yuesaoxinxi.ajax.edit",
        templateUrl:$M.config.appPath + "yuesaoxinxi/edit.html",
        onSubmit: function () {
            if (S.back) S.back();
        ...
        onLoad: function (sender) {
            ...
            sender.read("yuesaoxinxi.ajax.read", S.dataId, function (json) {
...
$M.yuesaoxinxi.uploadFile = function (S) {
    ...
    var uploadFile = function () {
        ...
        xhr.open("POST", $M.config.appPath + "yuesaoxinxi/upload.ashx");
        xhr.send(fd);
    }
